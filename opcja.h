...
void flux_add(double pos_V, double pos_A, int typ, vector<plaster>& layer_new);
void flux_add_dislocation(double pos_V, double pos_A, int typ, vector<plaster>& layer_new);
